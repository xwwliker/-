          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="sale in spuSaleAttrList" :key="sale.id">
                ...
                <dd changepirce="0" :class="{active:item.isChecked==1}" v-for="item in sale.spuSaleAttrValueList" :key="item.id" @click="changeActive(item,sale.spuSaleAttrValueList)">{{item.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
