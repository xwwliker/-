    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
         ...
         <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="this.total" :continues="5" @getPageNo="getPageNo"></Pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    changeorder (flag) {
      const oldorder = this.searchParams.order
      const oldFlag = oldorder.split(':')[0]
      const oldSort = oldorder.split(':')[1]
      if (oldFlag === flag) {
        if (oldSort === 'asc') {
